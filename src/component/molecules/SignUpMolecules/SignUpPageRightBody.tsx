...
import { fetchManagerRegister } from "../../../store/feature/managerSlice";
...
function SignUpPageRightBody() {
  ...
  const saveManager = async () =>{
    const response = await dispatch(fetchManagerRegister({companyName, email, name, surname, gender, password, rePassword, birthDate, department, title }));
  ...
  return (
    ...
    <option key={index} value={name}>
      ...
      <div className="row-btn row-right-sign-up">
        <button className="btn gradient-button-sign-up submit-button-sign-up" onClick={saveManager} disabled={password !== rePassword || password === ''}>
